...
public class InvoiceDataConverter {
    ...
    public InvoiceData convert(Invoice invoice) {
        Dictionary unitDict = dictionaryService.getDictionary(dictionaryService.getDictionaryNameFromAnnotation(Position.class, "unit"));
        Dictionary vatRateDict = dictionaryService.getDictionary(dictionaryService.getDictionaryNameFromAnnotation(Position.class, "vatRate"));
