...
public class ConfigurationController {
    ...
    @PostMapping("clear")
    @Operation(summary = "Clears configuration loaded previously with zip file")
    @ApiResponse(responseCode = "200", description = "Configuration has been removed from the database", content = @Content)
    public void clear() {
