...
import com.avispa.ecm.model.load.mapper.ApplicationMapper;
 ...
 */
@Component
class ApplicationLoader extends GenericLoader<Application, ApplicationDto, ApplicationMapper> {
    protected ApplicationLoader(EcmConfigRepository<Application> ecmConfigRepository, ApplicationMapper ecmConfigMapper, ContentService contentService) {
