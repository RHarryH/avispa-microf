...
import com.avispa.ecm.model.configuration.load.ConfigurationService;
...
class ConfigurationControllerTest {
    ...
    void givenEmptyZipFile_whenLoad_thenReturn400() throws Exception {
        var resource = ConfigurationControllerTest.class.getClassLoader().getResource("zip/empty-zip.zip");
    ...
    void givenCorrectZipFile_whenLoad_thenReturn201() throws Exception {
        var resource = ConfigurationControllerTest.class.getClassLoader().getResource("zip/non-empty-zip.zip");
        var file = new MockMultipartFile("configurationFile", resource.openStream());
